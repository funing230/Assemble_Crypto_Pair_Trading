...
# from GA_util import LSTM,Optimization,MyDataset,split_sequences,seed_everything,get_data,Normalizer
...
class HybridMlp:
    ...
    def create_problem(self):
        ...
        LB = [1,     1,     0,     0.001,   0,      0,   1,    1,   0.1, 4]
        UB = [6,     5,  5.99,    0.03,     4,   2.99,   6,    3,   0.8, 8]
    ...
    def decode_solution(self,solution, data):
        ...
        network_epoch = 100 * int(solution[1])
    ...
    def fitness_function(self, solution):
        ...
        # Model construction
        model=Net(input_dim,out_channels,hidden_dim,num_layers,output_dim,batch_size,kernel_size,dropout)
